...
public class MedicalStore {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 898, 566);
		...
		comboBoxBandages.setBounds(342, 102, 44, 21);
		...
		comboBoxMedkit.setBounds(342, 143, 44, 21);
		...
		comboBoxSurgical.setBounds(342, 193, 44, 21);
		...
		label_3.setBounds(416, 106, 46, 13);
		frame.getContentPane().add(label_3);
		
		JLabel label_4 = new JLabel("=");
		label_4.setBounds(416, 147, 46, 13);
		frame.getContentPane().add(label_4);
		
		JLabel label_5 = new JLabel("=");
		label_5.setBounds(416, 197, 46, 13);
		...
		comboBox.setBounds(342, 276, 44, 21);
		frame.getContentPane().add(comboBox);
		
		JComboBox comboBox_1 = new JComboBox();
		comboBox_1.setModel(new DefaultComboBoxModel(new String[] {"x0", "x1"}));
		comboBox_1.setMaximumRowCount(1);
		comboBox_1.setBounds(342, 323, 44, 21);
		frame.getContentPane().add(comboBox_1);
		
		JLabel label_8 = new JLabel("=");
		label_8.setBounds(416, 280, 46, 13);
		frame.getContentPane().add(label_8);
		
		JLabel label_9 = new JLabel("=");
		label_9.setBounds(416, 327, 46, 13);
		...
		label_10.setBounds(472, 106, 46, 13);
		frame.getContentPane().add(label_10);
		
		JLabel label_11 = new JLabel("$");
		label_11.setBounds(472, 147, 46, 13);
		frame.getContentPane().add(label_11);
		
		JLabel label_12 = new JLabel("$");
		label_12.setBounds(472, 197, 46, 13);
		frame.getContentPane().add(label_12);
		
		JLabel label_13 = new JLabel("$");
		label_13.setBounds(472, 280, 46, 13);
		frame.getContentPane().add(label_13);
		
		JLabel label_14 = new JLabel("$");
		label_14.setBounds(472, 327, 46, 13);
